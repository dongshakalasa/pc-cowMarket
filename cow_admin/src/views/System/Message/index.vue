<template>
  <div>
    ...
    <el-card style="margin-top: 30px">
      ...
      <el-table style="width: 100%" border :data="messages">
        <el-table-column label="序号" width="80px" align="center" type="index">
        </el-table-column>
        <el-table-column prop="mg_title" label="反馈标题" width="300"></el-table-column>
        <el-table-column prop="mg_describe" label="反馈内容"></el-table-column>
        <el-table-column prop="mg_time" label="反馈时间" width="300"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getDate() {
      ...
      const result = await this.$API.system.reqMessage(page, limit);
      if (result.code == 200) {
